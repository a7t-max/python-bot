...
BOT_TOKEN = "7578850980:AAGmgxJLPdsyBQQrHgSO0JEF-rmwjtRL7HY"
PAYMENT_CHANNEL = "@cash_earn_0021" #add payment channel here including the '@' sign
OWNER_ID = 7496038125 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@modderakash_offical"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
