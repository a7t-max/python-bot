...
BOT_TOKEN = "7319165997:AAECEw4GwWgBDTJCa4AJZYHLMKhopAzOiz4"
PAYMENT_CHANNEL = "@modderakashz" #add payment channel here including the '@' sign
OWNER_ID = 5605531603 #write owner's user id here.. get it from @CASH_2_UPI_BOT by /id
CHANNELS = ["@modderakashz"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
